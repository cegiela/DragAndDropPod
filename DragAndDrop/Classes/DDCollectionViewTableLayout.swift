//
//  DDCollectionViewTableLayout.swift
//  Pods
//
...
protocol DDCollectionViewTableLayoutDelegate {
...
struct TableLayoutPosition: Equatable {
    //Zero in either direction is interpreted as 'off the table' and not shown
...
class DDCollectionViewTableLayout: UICollectionViewLayout {
    ...
    var layoutDelegate: DDCollectionViewTableLayoutDelegate?
